 ...
 * @author wxlwang
 */
dojo.provide("com.easysoft.service.admin.favorite_type.Save");
dojo.declare( "com.easysoft.service.admin.favorite_type.Save" , "com.easysoft.service.admin.favorite_type.Add" , {
        postCreate:function(){
			var a=[],o={},op={},C=dojo.C;
			var op=this.getsbo();
			var obj={};
