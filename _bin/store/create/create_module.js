db.system.js.save({_id:"create_module",value:function () {
	...
	obj[C.MODULE_URL]="/easysoft/admin/favorite/"+C.REMOVE;
	...
	var obj={};
	obj[C.MODULE_NAME]=C.EASYSOFT+C.LOGINING2;
	...
	var obj={};
	obj[C.MODULE_NAME]=C.REGISTER+C.SUBMIT;
	obj[C.MODULE_URL]="/easysoft/"+C.REGISTER+C.SUBMIT;
