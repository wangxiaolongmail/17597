db.system.js.save({_id:"create_i18n",value:function () {
	...
	db.i18n.insert({_id:C.EASYSOFT+C.LOGIN,cn:"登录"});
	db.i18n.insert({_id:C.EASYSOFT+C.INDEX,cn:"网址"});
	db.i18n.insert({_id:C.EASYSOFT+C.ADMIN+C.START,cn:"开始"});
	db.i18n.insert({_id:C.EASYSOFT+C.ADMIN+C.FAVORITE+C.LIST,cn:"网址"});
	db.i18n.insert({_id:C.EASYSOFT+C.ADMIN+C.FAVORITE_TYPE+C.LIST,cn:"网址分类"});
