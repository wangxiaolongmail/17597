	;(function(){
		...
		d.setCls=_setCls;
		;function _getListClass( id_name , className ){
			var a=_getArray(id_name);
			var a=_filter(a,function(k,v){
				if( v.className.indexOf(className)>=0 ) return true;
			});
			return a;
		}
		d.getListClass=_getListClass;
	})();