	...
	var shiptypes={
		record:{
			...
			format:function(o){
				...
				_create(C.DIV,{style:{paddingLeft:"3px",paddingTop:"3px",width:70},innerHTML:o.title},node);
			}
		},
		fatrecord:{
			w:120,
			...
			format:function(o){
				...
				o.oh=_create(C.DIV,{style:{display:C.NONE}},node);
				if(o.className){
					_create(C.DIV,{className:o.className,style:{float:C.LEFT}},node);
					_create(C.DIV,{style:{paddingLeft:"45px",paddingTop:"9px",width:70},innerHTML:o.title},node);
				}else if(o.imagePath){
					var tmp=_create(C.DIV,{style:{float:C.LEFT}},node);
					_create("img",{src:o.imagePath},tmp);
					_create(C.DIV,{style:{paddingLeft:"45px",paddingTop:"9px",width:70},innerHTML:o.title},node);
				}else{
					_create(C.DIV,{style:{paddingLeft:"3px",paddingTop:"9px",width:70},innerHTML:o.title},node);
				}
				if(o.isClose){
