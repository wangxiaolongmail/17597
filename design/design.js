...
var data={
	...
	function __drag(o){
		...
		oh.onmousedown=function(e){
			...
			_d.onmousemove=function(e){
				o.mousemove(o,e.pageX-x,e.pageY-y);
			};
	...
	function touchObj(isTouch,o,src_obj,dest_index){
		var obj=data.nTouch;
		if(!obj.n){
			obj.n=_create("div",{
				style:{
	...
	function detectionTouchLink(isSameHouse,src_obj,src_i){
		...
		_each(data.list,function(dest_obj){
			...
			var flag=isSameHouse?flag:!flag;
			if(flag){
				_each(dest_obj.link,function(link,dest_i){
					if( collide(to,link) ){
						touchObj(true,dest_obj,src_obj,dest_i);
					}
				});
			}
		});
	...
	function drawShadowLine(o,i){
		...
		var o2=_getRMPoint(obj,1,false,1);
		...
		_each(data.list,function(o){
			...
			_each(o.link,function(item,i){
					...
					__drag({
						...
						i:i,
						mousedown:function(o){
							var node=o.o.link[o.i];
							node.n.style.zIndex=1000;
							node.n.style.cursor="crosshair";
						},
						mousemove:function(obj,x,y){
							var i=obj.i;
							var o=obj.o;
							drawShadow(o,x,y,i);
