...
(function($,_w,_d,_nav){
	...
	function _docElement() {
		return _QUIRKS ? _d.body : _d.documentElement;
	}
	...
	function byId(id) {
		return _d.getElementById(stripslashes(id));
	}
	...
	function _adjustShipSize(o,house){
		if(data.isSP){
			var w1=house.w-2*data.poolLeftPadding;
			var w2=o.shiptype.w;
			o.w=w1>w2?w2:w1;
		}else{
		}
