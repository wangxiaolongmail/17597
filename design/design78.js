...
var data={
	...
	function drawShadowLine(o,i){
		var obj=o.link[i];
		if(!obj.sha.nline){
			obj.sha.nline=_create("path");
		}
		var o1=_getLMPoint(o,1,false,1);
		var o2=_getRMPoint(obj.sha,1,false,1);
		_drawLine(obj.sha.nline,o1,o2);
	}
	function paint(){
		destroy();
		init();
			...
			_each(o.link,function(item,i){
					...
					__drag({
						...
						mousedown:function(o){
							...
							node.sha.n.style.zIndex=1000;
							node.sha.n.style.cursor="crosshair";
						},
						mousemove:function(obj,x,y){
							var i=obj.i;
							var o=obj.o;
							drawShadow(o,x,y,i);
							detectionTouch(false,o,o.link[i].sha);
						},
						mouseup:function(){
							drawNewLine();
							paint();
